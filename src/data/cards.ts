...
export const WARRIOR_CARDS: WarriorCard[] = [
  // ── 위(魏) 5장 ──
  {
    ...
    skills: [
      { name: '패왕의 기세', description: '아군 전체 무력+2', type: 'active' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '은인자중', description: '턴 종료 시 방어+1 누적', type: 'passive' },
  ...
  },
  {
    ...
    skills: [
      { name: '철벽수비', description: '방어+2, 1턴', type: 'active' },
    ],
  },
  {
    id: 'w-zhang-he',
  ...
  // ── 촉(蜀) 5장 ──
  {
    ...
    skills: [
      { name: '인덕', description: '아군 전체 HP+3 회복', type: 'active' },
  ...
  // ── 오(吳) 5장 ──
  {
    ...
    skills: [
      ...
      { name: '대의', description: '오 세력 방어+1', type: 'passive' },
    ],
  },
  {
    id: 'w-zhou-yu',
  ...
  },
  {
    ...
    skills: [
      { name: '폭정', description: '적 전체 통솔-2', type: 'active' },
    ],
  },
];
